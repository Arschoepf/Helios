...
export const nl: Translations = {
    ...
    detail:
    {
        ...
        chartProductionTitle: 'Dagelijkse opwekking',
        chartBatteryTitle:    'Batterij',
        chartGridTitle:       'Net',
        tileProductionLabel:  'Opwekking',
        tileForecastLabel:    'Verwachting',
        tileChargeLabel:      'Opladen',
        tileDischargeLabel:   'Ontladen',
        tileImportLabel:      'Import',
        tileExportLabel:      'Export',
        tooltipForecastLabel: 'Verwachting',
        tooltipMeasuredLabel: 'Gemeten opwekking',
