...
export const nl: Translations = {
    ...
    editor:
    {
        ...
        autoRotateOff:      'Uit',
        cameraTitle:        'Camera',
        cameraHint:         'Rustpositie van de camera die bij elke initialisatie van de kaart wordt toegepast. Sleep de schuifregelaars voor een live voorbeeld, de waarden die je kiest overschrijven de automatische standaard bij de volgende render. De resetknop rechtsonder zet alles terug naar de automatische positie.',
        cameraPitch:        'Verticale kanteling',
        cameraBearing:      'Horizontale rotatie',
        cameraLocked:       'Rotatie vergrendelen',
        cameraLockedOn:     'Vergrendeld',
        cameraLockedOff:    'Vrij',
        cameraLockedHelp:   'Wanneer vergrendeld, zijn sleep-rotatie en sleep-kanteling op de kaart uitgeschakeld en wordt de automatische rotatie bij inactiviteit opgeschort.',
        cameraReset:        'Resetten',
