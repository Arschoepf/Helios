...
export const nl: Translations = {
    ...
    editor:
    {
        ...
        displayUpdateFrequencyHelp:   'Hoe vaak per uur elke grafiek zijn waarden ververst: 1 staat gelijk aan één punt per uur (vloeiende curve, laagste CPU), 60 staat gelijk aan één punt per minuut (precieze curve, hoogste CPU). Standaard 4 = een waarde elke 15 minuten, een goede balans tussen zichtbare nauwkeurigheid en renderkosten. De prognosecurve wordt niet beïnvloed: die loopt altijd op de oorspronkelijke uurlijkse cadans van het weermodel.',
