...
export const pl: Translations = {
    ...
    detail:
    {
        ...
        loadingLabel:         'Pobieranie danych, proszę czekać...',
        radialProductionLabel: 'Produkcja',
        radialBatteryLabel:    'Bateria',
        radialCloudLabel:      'Zachmurzenie',
    ...
    editor:
    {
        ...
        pvArrayTrackerSingleH:  'Jednoosiowy poziomy (nachylenie podąża)',
        pvArrayTrackerSingleV:  'Jednoosiowy pionowy (azymut podąża)',
        pvArrayTrackerHelp:     'Większość instalacji domowych jest stała: panel pozostaje na ustawionym nachyleniu i azymucie. Wybierz typ trackera, jeśli twoje panele fizycznie poruszają się, aby śledzić słońce. Dwuosiowy utrzymuje powierzchnię panelu skierowaną prosto na słońce przez cały dzień (maksymalna wydajność). Jednoosiowy poziomy zachowuje ustawiony azymut, ale nachyla się w górę i w dół, gdy słońce wschodzi i zachodzi. Jednoosiowy pionowy zachowuje ustawione nachylenie, ale obraca się wokół osi pionowej, aby śledzić azymut słońca.',
