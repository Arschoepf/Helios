...
export const pl: Translations = {
    ...
    editor:
    {
        ...
        cameraTitle:        'Kamera',
        cameraHint:         'Spoczynkowe ustawienie kamery stosowane przy każdej inicjalizacji karty. Przeciągnij suwaki, aby zobaczyć podgląd na żywo, wybrane wartości zastąpią automatyczne ustawienie przy następnym renderowaniu. Przycisk resetu w prawym dolnym rogu przywraca wszystko do automatycznej pozycji.',
        cameraPitch:        'Nachylenie pionowe',
        cameraBearing:      'Obrót poziomy',
        cameraLocked:       'Zablokuj obrót',
        cameraLockedOn:     'Zablokowana',
        cameraLockedOff:    'Swobodna',
        cameraLockedHelp:   'Gdy jest zablokowana, gesty obrotu i nachylenia są wyłączone na karcie, a automatyczna orbita w trybie bezczynności jest wstrzymana.',
        cameraReset:        'Resetuj',
