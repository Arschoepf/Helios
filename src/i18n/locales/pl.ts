...
export const pl: Translations = {
    ...
    detail:
    {
        ...
        chartProductionTitle: 'Produkcja dzienna',
        chartBatteryTitle:    'Bateria',
        chartGridTitle:       'Sieć',
        tileProductionLabel:  'Produkcja',
        tileForecastLabel:    'Prognoza',
        tileChargeLabel:      'Ładowanie',
        tileDischargeLabel:   'Rozładowanie',
        tileImportLabel:      'Pobór',
        tileExportLabel:      'Oddawanie',
        tooltipForecastLabel: 'Prognoza',
        tooltipMeasuredLabel: 'Rzeczywista produkcja',
