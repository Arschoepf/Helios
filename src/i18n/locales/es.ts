...
export const es: Translations = {
    ...
    editor:
    {
        ...
        cameraTitle:        'Cámara',
        cameraHint:         'Posición de reposo de la cámara aplicada cada vez que la tarjeta se inicializa. Arrastra los deslizadores para una vista previa en vivo, los valores que elijas anularán el ajuste automático en el siguiente renderizado. El botón de reinicio en la esquina inferior derecha restablece todo a la posición automática.',
        cameraPitch:        'Inclinación vertical',
        cameraBearing:      'Rotación horizontal',
        cameraLocked:       'Bloquear rotación',
        cameraLockedOn:     'Bloqueada',
        cameraLockedOff:    'Libre',
        cameraLockedHelp:   'Mientras está bloqueada, los gestos de rotación y de inclinación quedan desactivados en la tarjeta y la órbita automática en reposo queda suspendida.',
