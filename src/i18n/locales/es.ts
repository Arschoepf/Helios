...
export const es: Translations = {
    ...
    editor:
    {
        ...
        displayUpdateFrequencyHelp:   'Cuántas veces por hora cada gráfico refresca sus valores: 1 equivale a un único punto por hora (curva suave, mínima CPU), 60 equivale a un punto por minuto (curva precisa, máxima CPU). Por defecto 4 = un valor cada 15 minutos, un buen equilibrio entre precisión visible y coste de renderizado. La curva de previsión no se ve afectada: siempre va al ritmo horario nativo del modelo meteorológico.',
