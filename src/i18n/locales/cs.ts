...
export const cs: Translations = {
    ...
    editor:
    {
        ...
        cameraTitle:        'Kamera',
        cameraHint:         'Klidová poloha kamery použitá při každé inicializaci karty. Tažením posuvníků získáte živý náhled, hodnoty, které zvolíte, přepíšou automatické výchozí nastavení při dalším vykreslení. Tlačítko reset vpravo dole vrátí vše zpět do automatické polohy.',
        cameraPitch:        'Svislý sklon',
        cameraBearing:      'Vodorovné otočení',
        cameraLocked:       'Uzamknout otáčení',
        cameraLockedOn:     'Uzamčeno',
        cameraLockedOff:    'Volné',
        cameraLockedHelp:   'Když je uzamčeno, gesta otáčení a naklánění tažením jsou na kartě zakázána a automatická orbita při nečinnosti je pozastavena.',
        cameraReset:        'Resetovat',
