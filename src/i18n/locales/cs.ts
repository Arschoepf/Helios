...
export const cs: Translations = {
    ...
    detail:
    {
        ...
        chartProductionTitle: 'Denní výroba',
        chartBatteryTitle:    'Baterie',
        chartGridTitle:       'Síť',
        tileProductionLabel:  'Výroba',
        tileForecastLabel:    'Předpověď',
        tileChargeLabel:      'Nabíjení',
        tileDischargeLabel:   'Vybíjení',
        tileImportLabel:      'Odběr',
        tileExportLabel:      'Dodávka',
        tooltipForecastLabel: 'Předpověď',
        tooltipMeasuredLabel: 'Naměřená výroba',
        dayLabelToday:        'Dnes',
