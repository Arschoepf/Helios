...
export const cs: Translations = {
    ...
    editor:
    {
        ...
        displayUpdateFrequencyHelp:   'Kolikrát za hodinu každý graf obnovuje své hodnoty: 1 znamená jeden bod za hodinu (hladká křivka, nejnižší zátěž CPU), 60 znamená jeden bod za minutu (přesná křivka, nejvyšší zátěž CPU). Výchozí 4 = hodnota každých 15 minut, vyvážený kompromis mezi viditelnou přesností a nákladem na vykreslení. Křivka předpovědi není ovlivněna: vždy běží v nativní hodinové kadenci povětrnostního modelu.',
