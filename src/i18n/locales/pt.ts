...
export const pt: Translations = {
    ...
    editor:
    {
        ...
        cameraTitle:        'Câmara',
        cameraHint:         'Posição de repouso da câmara aplicada sempre que o cartão é inicializado. Arrasta os deslizadores para uma pré-visualização ao vivo, os valores que escolheres substituem a predefinição automática na próxima renderização. O botão de reposição no canto inferior direito repõe tudo na posição automática.',
        cameraPitch:        'Inclinação vertical',
        cameraBearing:      'Rotação horizontal',
        cameraLocked:       'Bloquear rotação',
        cameraLockedOn:     'Bloqueada',
        cameraLockedOff:    'Livre',
        cameraLockedHelp:   'Quando bloqueada, os gestos de rotação e de inclinação ficam desativados no cartão e a órbita automática em inatividade é suspensa.',
        cameraReset:        'Repor',
