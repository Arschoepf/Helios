...
export const it: Translations = {
    ...
    editor:
    {
        ...
        displayUpdateFrequencyHelp:   'Quante volte all\'ora ciascun grafico aggiorna i valori: 1 corrisponde a un singolo punto all\'ora (curva morbida, CPU minima), 60 corrisponde a un punto al minuto (curva precisa, CPU massima). Predefinito 4 = un valore ogni 15 minuti, un buon compromesso tra precisione visibile e costo di rendering. La curva di previsione non è interessata: gira sempre sulla cadenza oraria nativa del modello meteo.',
