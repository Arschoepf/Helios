...
export const it: Translations = {
    ...
    detail:
    {
        ...
        chartProductionTitle: 'Produzione giornaliera',
        chartBatteryTitle:    'Batteria',
        chartGridTitle:       'Rete',
        tileProductionLabel:  'Produzione',
        tileForecastLabel:    'Previsione',
        tileChargeLabel:      'Carica',
        tileDischargeLabel:   'Scarica',
        tileImportLabel:      'Importazione',
        tileExportLabel:      'Esportazione',
        tooltipForecastLabel: 'Previsione',
        tooltipMeasuredLabel: 'Produzione misurata',
        dayLabelToday:        'Oggi',
