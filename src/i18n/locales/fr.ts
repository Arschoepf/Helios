...
export const fr: Translations = {
    ...
    editor:
    {
        ...
        displayUpdateFrequency:       'Fréquence de mise à jour',
        displayUpdateFrequencyHelp:   'Combien de fois par heure chaque graphique rafraîchit ses valeurs : 1 = un point par heure (courbe lissée, CPU minimal), 60 = un point par minute (courbe précise, CPU maximal). Par défaut 4 = une valeur toutes les 15 minutes, un bon compromis entre précision visible et coût de rendu. La courbe de prévision n\'est pas concernée : elle reste calée sur la cadence horaire native du modèle météo.',
