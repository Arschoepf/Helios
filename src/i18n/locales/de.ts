...
export const de: Translations = {
    ...
    editor:
    {
        ...
        autoRotateOff:      'Aus',
        cameraTitle:        'Kamera',
        cameraHint:         'Ruhe-Kameraposition, die bei jedem Initialisieren der Karte angewendet wird. Ziehe die Regler für eine Live-Vorschau, die gewählten Werte überschreiben die automatische Voreinstellung beim nächsten Rendern. Die Reset-Schaltfläche unten rechts setzt alles wieder auf die automatische Ausrichtung zurück.',
        cameraPitch:        'Vertikale Neigung',
        cameraBearing:      'Horizontale Drehung',
        cameraLocked:       'Drehung sperren',
        cameraLockedOn:     'Gesperrt',
        cameraLockedOff:    'Frei',
        cameraLockedHelp:   'Im gesperrten Zustand sind Dreh- und Neige-Gesten auf der Karte deaktiviert und die automatische Leerlauf-Rotation wird angehalten.',
        cameraReset:        'Zurücksetzen',
