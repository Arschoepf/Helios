...
export const sv: Translations = {
    ...
    editor:
    {
        ...
        pvArrayTracker:         'Solföljare',
        pvArrayTrackerNone:     'Fast installation',
        pvArrayTrackerDual:     'Tvåaxlig (följer solen)',
        pvArrayTrackerSingleH:  'Enaxlig horisontell (lutning följer)',
        pvArrayTrackerSingleV:  'Enaxlig vertikal (azimut följer)',
        pvArrayTrackerHelp:     'De flesta bostadsinstallationer är fasta: panelen ligger kvar i den konfigurerade lutningen och azimuten. Välj en följartyp om dina paneler fysiskt rör sig för att följa solen. Tvåaxlig håller panelens yta riktad rakt mot solen hela dagen (max effekt). Enaxlig horisontell behåller den konfigurerade azimuten men lutar upp och ner när solen går upp och ner. Enaxlig vertikal behåller den konfigurerade lutningen men roterar runt den vertikala axeln för att följa solens azimut.',
