...
export const en: Translations = {
    ...
    detail:
    {
        ...
        chartProductionTitle: 'Daily production',
        chartBatteryTitle:    'Battery',
        chartGridTitle:       'Grid',
        tileProductionLabel:  'Production',
        tileForecastLabel:    'Forecast',
        tileChargeLabel:      'Charge',
        tileDischargeLabel:   'Discharge',
        tileImportLabel:      'Import',
        tileExportLabel:      'Export',
        tooltipForecastLabel: 'Forecast',
        tooltipMeasuredLabel: 'Measured production',
        dayLabelToday:        'Today',
