...
| 🇩🇪 Germany (Brandenburg + Berlin) | Brandenburg + Berlin | LGB bDOM + DGM 1 m | ~6.1 M | GeoTIFF Float32 via WCS 2.0.1 (DSM - DTM subtracted) | EPSG:4326 native + 25832 + 25833 | `isk.geobasis-bb.de/ows/bdom_wcs` and `isk.geobasis-bb.de/ows/dgm_wcs` | [Berlin 1 km² bDOM](https://isk.geobasis-bb.de/ows/bdom_wcs?SERVICE=WCS&VERSION=2.0.1&REQUEST=GetCoverage&COVERAGEID=bb_bdom&FORMAT=image/tiff&SUBSETTINGCRS=http://www.opengis.net/def/crs/EPSG/0/4326&SUBSET=Long(13.40,13.41)&SUBSET=Lat(52.51,52.52)&SCALESIZE=Long(256),Lat(256)) |
| 🇩🇪 Germany (Baden-Württemberg) | Baden-Württemberg | LGL INSPIRE DOM5 + DGM1 | ~11.3 M | GeoTIFF Float32 via WCS 2.0.1 (DSM 5 m, DTM 1 m, subtracted) | EPSG:4326 native + 25832 + 4258 | `owsproxy.lgl-bw.de/owsproxy/wcs/WCS_INSP_BW_Hoehe_Coverage_DOM5` and `.../WCS_INSP_BW_Hoehe_Coverage_DGM1` | [Stuttgart 1 km² DOM](https://owsproxy.lgl-bw.de/owsproxy/wcs/WCS_INSP_BW_Hoehe_Coverage_DOM5?SERVICE=WCS&VERSION=2.0.1&REQUEST=GetCoverage&COVERAGEID=EL.ElevationGridCoverage&FORMAT=image/tiff&SUBSETTINGCRS=http://www.opengis.net/def/crs/EPSG/0/4326&SUBSET=Long(9.17,9.18)&SUBSET=Lat(48.77,48.78)&SCALESIZE=Long(256),Lat(256)) |
| 🇦🇹 Austria | Tirol (Tyrol) | Land Tirol ALS DGM + DOM 5 m | ~760 K | GeoTIFF Float32 via WCS 2.0.1 (DSM - DTM subtracted) | EPSG:4326 native + 31254 + 31255 | `gis.tirol.gv.at/arcgis/services/Service_Public/terrain/MapServer/WCSServer` | [Innsbruck 1 km² DOM](https://gis.tirol.gv.at/arcgis/services/Service_Public/terrain/MapServer/WCSServer?SERVICE=WCS&VERSION=2.0.1&REQUEST=GetCoverage&COVERAGEID=Oberflaechenmodell_5m_M28&FORMAT=image/tiff&SUBSETTINGCRS=http://www.opengis.net/def/crs/EPSG/0/4326&SUBSET=Lat(47.26,47.27)&SUBSET=Long(11.39,11.40)&SCALESIZE=Lat(256),Long(256)) |
| 🇺🇸 United States | Vermont | VCGI Statewide nDSM 0.7 m | ~645 K | Float32 GeoTIFF via ArcGIS exportImage (pre-normalised, single fetch) | EPSG:3857 native, accepts EPSG:4326 input + output | `maps.vcgi.vermont.gov/arcgis/rest/services/EGC_services/IMG_VCGI_LIDARNDSM_WM_CACHE_v1/ImageServer` | [Burlington 1 km² nDSM](https://maps.vcgi.vermont.gov/arcgis/rest/services/EGC_services/IMG_VCGI_LIDARNDSM_WM_CACHE_v1/ImageServer/exportImage?bbox=-73.22,44.47,-73.21,44.48&bboxSR=4326&imageSR=4326&size=256,256&format=tiff&pixelType=F32&interpolation=RSP_BilinearInterpolation&f=image) |
